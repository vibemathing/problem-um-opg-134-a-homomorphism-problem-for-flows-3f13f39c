...
```json
{
  ...
  "attempts": [
    {
      "artifacts": [],
      "attempt_id": "attempt:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-source-fidelity-01",
      "claims": [],
      "completed_at": null,
      "generator": "trusted-rolling-source-admission-v1",
      "inputs": [
        "problem-library/records/canonical-problems.jsonl",
        "https://www.unsolvedmath.com/problems/OPG-134"
      ],
      "lifecycle": "planned",
      "method": "discovery",
      "objective": "Close the source-fidelity obligation before attempting the frozen root statement.",
      "obligation_graph_id": "graph:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-v1",
      "problem_contract_sha256": "447f5bc2d42e2c91baf15fcd1ffafb60d70d10e3a1aa97f9381afcca316ce416",
      "problem_id": "problem:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c",
      "route_id": "route:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-source-fidelity",
  ...
  "obligation_graphs": [
    {
      "attempt_id": "attempt:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-source-fidelity-01",
      "graph_id": "graph:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-v1",
      "obligations": [
        {
          "dependencies": [
            "obligation:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-statement-fidelity"
          ],
          "kind": "root_claim",
          "obligation_id": "obligation:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-root",
          "statement": {
            "formal_declaration": null,
            "language": "en",
            "text": "Conjecture Let $M,M'$ be abelian groups and let $B \\subseteq M$ and $B' \\subseteq M'$ satisfy $B=-B$ and $B' = -B'$. If there is a homomorphism from $Cayley(M,B)$ to $Cayley(M',B')$, then every graph with a B-flow has a B'-flow."
          },
          "statement_sha256": "acc8f37cc7214df04cfa63cb655a7bbb2b23e25dcbe24a8d784108d5cc66bd1b"
        },
        {
          "dependencies": [],
          "kind": "definition",
          "obligation_id": "obligation:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-statement-fidelity",
          "statement": {
            "formal_declaration": null,
            "language": "en",
      ...
      "root_obligation_id": "obligation:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-root",
      "route_id": "route:um-opg-134-a-homomorphism-problem-for-flows-3f13f39c-source-fidelity"
    }
  ],
  "problem_contract": {
    ...
    "sources": [
      {
        ...
        "source_record_id": "unsolvedmath-opg-134-1833a8dca354",
        "url": "https://www.unsolvedmath.com/problems/OPG-134"
      },
      {
        "retrieved_at": "2026-09-02T00:06:43Z",
